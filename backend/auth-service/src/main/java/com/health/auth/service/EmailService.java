...
public class EmailService {
    ...
    public void sendVerificationEmail(String email, String verificationToken) {
        ...
        String path = "/auth/signup/verify";
    ...
    private void sendEmail(String email, String token, String subject, String path, String message) {
        try {
            ...
            String frontendUrl = "http://localhost:5173"; // your React app
        ...
        <a href="%s" style="display: inline-block; margin:20px 0; padding:10px 20px;font-size:16px;color:#fff;background-color:#007bff;text-decoration:none;">Reset Password</a>
